...
export function MenuItemContent({ menu, listeners, onEdit, onDelete, canEdit, canSort, canDelete, isAccordionTrigger }: MenuItemContentProps) {
    const menuContent = (
    ...
    return (
        <div className="flex w-full items-center">
            {canSort && (
                <div
                    {...listeners}
                    className="cursor-grab pr-2 text-muted-foreground transition-colors hover:text-foreground"
